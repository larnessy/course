...
public class Main {
    ...
    public CommandLineRunner commandLineRunner(JpaCityService jpaCityService,
        ...
        return args -> {
            ...
            jpaWeatherConditionService.insert(weatherCondition);
            ...
            jpaWeatherService.insert(weatherEntity1);
            jpaWeatherService.insert(weatherEntity2);
            ...
            jdbcWeatherConditionService.insert(weatherCondition2);
            ...
            jdbcWeatherService.insert(weatherEntity3);
            jdbcWeatherService.insert(weatherEntity4);
